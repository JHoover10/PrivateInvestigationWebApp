<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CaseEdit.aspx.cs" Inherits="WebApplication1.CaseEdit" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display." 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ValidateRequestMode="Enabled">
                                    <ItemTemplate>
                                        <asp:linkButton ID="EditButton" runat="server" Text="Edit" OnClick="EditCase"/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
