<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CaseEditSelected.aspx.cs" Inherits="WebApplication1.CaseEditSelected" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-xs-2" style="width: 15%">
                <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a style="background-color: steelblue" href="/Cases/CaseInfo.aspx">Case Information</a></li>
                    <li class="dropdown">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [CaseIntake]"></asp:SqlDataSource>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td class="auto-style2">
                <asp:TextBox ID="ClientName" runat="server" Width="190px" DataSourceID="SqlDataSource1"></asp:TextBox>
            </td>
            <td class="auto-style3">Lead Counsel:</td>
            <td>
                <asp:TextBox ID="LeadCounsel" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style3">Case Number:</td>
            <td class="auto-style2">
                <asp:TextBox ID="CaseNumber" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style3">Second Chair Counsel:</td>
            <td>
                <asp:TextBox ID="SecondChairCounsel" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td class="auto-style2">
                <asp:TextBox ID="Charges" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style6">Facility Name:</td>
            <td>
                <asp:TextBox ID="FacilityName" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="BookingNumber" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style4">Name:</td>
            <td class="auto-style2">
                <asp:TextBox ID="JudgeName" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style6">Cell Location:</td>
            <td>
                <asp:TextBox ID="CellLocation" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style4">Court House:</td>
            <td class="auto-style2">
                <asp:TextBox ID="CourtHouse" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style6">Phone:</td>
            <td>
                <asp:TextBox ID="FacilityPhone" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style4">Phone:</td>
            <td class="auto-style2">
                <asp:TextBox ID="JudgePhone" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style6">Mailing Address:</td>
            <td>
                <asp:TextBox ID="MailingAddress" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style4">JA Email:</td>
            <td class="auto-style2">
                <asp:TextBox ID="JAEmail" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style6">Physical Address:</td>
            <td>
                <asp:TextBox ID="PhysicalAddress" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style4">Address:</td>
            <td class="auto-style2">
                <asp:TextBox ID="JudgeAddress" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style6">Visiting Policy:</td>
            <td>
                <asp:TextBox ID="VisitingPolicy" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table style="width: 100%;">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td class="auto-style2">
                <asp:TextBox ID="StateAttorney1Name" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style7">Name:</td>
            <td class="auto-style8">
                <asp:TextBox ID="StateParalegalName" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style9">Name:</td>
            <td>
                <asp:TextBox ID="StateAttorney2Name" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style7">Phone:</td>
            <td class="auto-style2">
                <asp:TextBox ID="StateAttorney1Phone" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style7">Phone:</td>
            <td class="auto-style8">
                <asp:TextBox ID="StateParalegalPhone" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style9">Phone:</td>
            <td>
                <asp:TextBox ID="StateAttorney2Phone" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style7">Email:</td>
            <td class="auto-style2">
                <asp:TextBox ID="StateAttorney1Email" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style7">Email:</td>
            <td class="auto-style8">
                <asp:TextBox ID="StateParalegalEmail" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style9">Email:</td>
            <td>
                <asp:TextBox ID="StateAttorney2Email" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style7">Law Office:</td>
            <td class="auto-style2">
                <asp:TextBox ID="StateAttorney1LawOffice" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style7">Law Office:</td>
            <td class="auto-style8">
                <asp:TextBox ID="StateParalegalLawOffice" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style9">Law Office:</td>
            <td>
                <asp:TextBox ID="StateAttorney2LawOffice" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
    </table>
    <table style="width: 100%;">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td class="auto-style7">Name:</td>
            <td class="auto-style2">
                <asp:TextBox ID="DefenseLeadCounselName" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style7">Name:</td>
            <td class="auto-style8">
                <asp:TextBox ID="DefenseParalegalName" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style9">Name:</td>
            <td>
                <asp:TextBox ID="DefenseSecondChairName" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style7">Phone:</td>
            <td class="auto-style2">
                <asp:TextBox ID="DefenseLeadCounselPhone" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style7">Phone:</td>
            <td class="auto-style8">
                <asp:TextBox ID="DefenseParalegalPhone" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style9">Phone:</td>
            <td>
                <asp:TextBox ID="DefenseSecondChairPhone" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style7">Email:</td>
            <td class="auto-style2">
                <asp:TextBox ID="DefenseLeadCounselEmail" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style7">Email:</td>
            <td class="auto-style8">
                <asp:TextBox ID="DefenseParalegalEmail" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style9">Email:</td>
            <td>
                <asp:TextBox ID="DefenseSecondChairEmail" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style7">Law Office:</td>
            <td class="auto-style2">
                <asp:TextBox ID="DefenseLeadCounselLawOffice" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style7">Law Office:</td>
            <td class="auto-style8">
                <asp:TextBox ID="DefenseParalegalLawOffice" runat="server" Width="190px"></asp:TextBox>
            </td>
            <td class="auto-style9">Law Office:</td>
            <td>
                <asp:TextBox ID="DefenseSecondChairLawOffice" runat="server" Width="190px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Button ID="Button2" runat="server" Text="Save" OnClick="Click_CaseInfoSave" />
